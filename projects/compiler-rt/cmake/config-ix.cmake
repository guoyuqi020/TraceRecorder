...
set(ALL_TREC_SUPPORTED_ARCH ${X86_64} ${MIPS64} ${ARM64} ${PPC64})
...
if(APPLE)
    ...
    foreach(platform ${DARWIN_EMBEDDED_PLATFORMS})
      if(DARWIN_${platform}sim_SYSROOT)
        ...
        if(DARWIN_${platform}sim_ARCHS)
          ...
          list(APPEND TREC_SUPPORTED_OS ${platform}sim)
      ...
      if(DARWIN_${platform}_SYSROOT)
        ...
        if(DARWIN_${platform}_ARCHS)
          ...
          list_intersect(DARWIN_${platform}_TREC_ARCHS DARWIN_${platform}_ARCHS ALL_TREC_SUPPORTED_ARCH)
          if(DARWIN_${platform}_TREC_ARCHS)
            list(APPEND TREC_SUPPORTED_OS ${platform})
          endif()
  ...
  list_intersect(PROFILE_SUPPORTED_ARCH
    ...
    SANITIZER_COMMON_SUPPORTED_ARCH)
  list_intersect(TREC_SUPPORTED_ARCH
    ALL_TREC_SUPPORTED_ARCH
    SANITIZER_COMMON_SUPPORTED_ARCH)
  ...
  filter_available_targets(TREC_SUPPORTED_ARCH ${ALL_TREC_SUPPORTED_ARCH})
...
set(ALL_SANITIZERS asan;dfsan;msan;hwasan;trec;tsan;safestack;cfi;scudo;ubsan_minimal;gwp_asan)
...
if (COMPILER_RT_HAS_SANITIZER_COMMON AND TREC_SUPPORTED_ARCH AND
    OS_NAME MATCHES "Darwin|Linux|FreeBSD|Android|NetBSD")
  set(COMPILER_RT_HAS_TREC TRUE)
else()
  set(COMPILER_RT_HAS_TREC FALSE)
endif()
