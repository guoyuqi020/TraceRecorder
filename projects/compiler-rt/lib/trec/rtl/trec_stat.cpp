...
void StatOutput(u64 *stat) {
  ...
  name[Stat__trec_mutex_create]          = "  __trec_mutex_create             ";
  name[Stat__trec_mutex_destroy]         = "  __trec_mutex_destroy            ";
  name[Stat__trec_mutex_pre_lock]        = "  __trec_mutex_pre_lock           ";
  name[Stat__trec_mutex_post_lock]       = "  __trec_mutex_post_lock          ";
  name[Stat__trec_mutex_pre_unlock]      = "  __trec_mutex_pre_unlock         ";
  name[Stat__trec_mutex_post_unlock]     = "  __trec_mutex_post_unlock        ";
  name[Stat__trec_mutex_pre_signal]      = "  __trec_mutex_pre_signal         ";
  name[Stat__trec_mutex_post_signal]     = "  __trec_mutex_post_signal        ";
  name[Stat__trec_mutex_pre_divert]      = "  __trec_mutex_pre_divert         ";
  name[Stat__trec_mutex_post_divert]     = "  __trec_mutex_post_divert        ";
