...
SANITIZER_INTERFACE_ATTRIBUTE void __trec_branch();

SANITIZER_INTERFACE_ATTRIBUTE void __trec_func_param(char param_idx,
                                                     void *src_addr,
                                                     char src_idx);
SANITIZER_INTERFACE_ATTRIBUTE void __trec_func_exit_param(void *src_addr,
                                                          char src_idx);
SANITIZER_INTERFACE_ATTRIBUTE void __trec_func_enter_order(char idx);
...
SANITIZER_INTERFACE_ATTRIBUTE void __trec_write8(void *addr, bool isPtr,
                                                 ...
                                                 void *val_src_addr,
                                                 char val_src_idx);
SANITIZER_INTERFACE_ATTRIBUTE void __trec_write16(
    void *addr, bool isPtr, __uint128_t val, void *addr_src_addr,
    char addr_src_idx, void *val_src_addr, char val_src_idx);

SANITIZER_INTERFACE_ATTRIBUTE void __trec_unaligned_read2(const void *addr,
                                                          bool isPtr, void *val,
                                                          void *addr_src_addr,
                                                          char addr_src_idx);
SANITIZER_INTERFACE_ATTRIBUTE void __trec_unaligned_read4(const void *addr,
                                                          bool isPtr, void *val,
                                                          void *addr_src_addr,
                                                          char addr_src_idx);
SANITIZER_INTERFACE_ATTRIBUTE void __trec_unaligned_read8(const void *addr,
                                                          bool isPtr, void *val,
                                                          void *addr_src_addr,
                                                          char addr_src_idx);
SANITIZER_INTERFACE_ATTRIBUTE void __trec_unaligned_read16(const void *addr,
                                                           bool isPtr,
                                                           __uint128_t val,
                                                           void *addr_src_addr,
                                                           char addr_src_idx);
...
SANITIZER_INTERFACE_ATTRIBUTE void __trec_unaligned_write2(
    void *addr, bool isPtr, void *val, void *addr_src_addr, char addr_src_idx,
...
SANITIZER_INTERFACE_ATTRIBUTE void __trec_func_entry(void *call_pc);
SANITIZER_INTERFACE_ATTRIBUTE void __trec_func_exit();

SANITIZER_INTERFACE_ATTRIBUTE void __trec_ignore_thread_begin();
SANITIZER_INTERFACE_ATTRIBUTE void __trec_ignore_thread_end();

SANITIZER_INTERFACE_ATTRIBUTE
void *__trec_external_register_tag(const char *object_type);
SANITIZER_INTERFACE_ATTRIBUTE
void __trec_external_register_header(void *tag, const char *header);
SANITIZER_INTERFACE_ATTRIBUTE
void __trec_external_assign_tag(void *addr, void *tag);
SANITIZER_INTERFACE_ATTRIBUTE
void __trec_external_read(void *addr, void *caller_pc, void *tag);
SANITIZER_INTERFACE_ATTRIBUTE
void __trec_external_write(void *addr, void *caller_pc, void *tag);

SANITIZER_INTERFACE_ATTRIBUTE
void __trec_read_range(void *addr, unsigned long size);
SANITIZER_INTERFACE_ATTRIBUTE
void __trec_write_range(void *addr, unsigned long size);

SANITIZER_INTERFACE_ATTRIBUTE
void __trec_read_range_pc(void *addr, unsigned long size,
                          void *pc);  // NOLINT
SANITIZER_INTERFACE_ATTRIBUTE
void __trec_write_range_pc(void *addr, unsigned long size,
                           void *pc);  // NOLINT
