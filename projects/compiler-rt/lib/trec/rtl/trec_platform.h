...
uptr MappingImpl(void) {
  switch (Type) {
#if !SANITIZER_GO
    case MAPPING_LO_APP_BEG:
      return Mapping::kLoAppMemBeg;
    case MAPPING_LO_APP_END:
      return Mapping::kLoAppMemEnd;
#ifdef TREC_MID_APP_RANGE
    case MAPPING_MID_APP_BEG:
      return Mapping::kMidAppMemBeg;
    case MAPPING_MID_APP_END:
      return Mapping::kMidAppMemEnd;
#endif
    case MAPPING_HI_APP_BEG:
      return Mapping::kHiAppMemBeg;
    case MAPPING_HI_APP_END:
      return Mapping::kHiAppMemEnd;
    case MAPPING_HEAP_BEG:
      return Mapping::kHeapMemBeg;
    case MAPPING_HEAP_END:
      return Mapping::kHeapMemEnd;
    case MAPPING_VDSO_BEG:
      return Mapping::kVdsoBeg;
#else
    case MAPPING_APP_BEG:
      return Mapping::kAppMemBeg;
    case MAPPING_APP_END:
      return Mapping::kAppMemEnd;
#endif
    case MAPPING_SHADOW_BEG:
      return Mapping::kShadowBeg;
    case MAPPING_SHADOW_END:
      return Mapping::kShadowEnd;
    case MAPPING_META_SHADOW_BEG:
      return Mapping::kMetaShadowBeg;
    case MAPPING_META_SHADOW_END:
      return Mapping::kMetaShadowEnd;
    case MAPPING_TRACE_BEG:
      return Mapping::kTraceMemBeg;
    case MAPPING_TRACE_END:
...
uptr MappingArchImpl(void) {
  ...
  switch (vmaSize) {
    ...
    case 47:
      return MappingImpl<Mapping47, Type>();
  }
  DCHECK(0);
  return 0;
#else
...
#if !SANITIZER_GO
ALWAYS_INLINE
uptr LoAppMemBeg(void) { return MappingArchImpl<MAPPING_LO_APP_BEG>(); }
ALWAYS_INLINE
uptr LoAppMemEnd(void) { return MappingArchImpl<MAPPING_LO_APP_END>(); }

#ifdef TREC_MID_APP_RANGE
ALWAYS_INLINE
uptr MidAppMemBeg(void) { return MappingArchImpl<MAPPING_MID_APP_BEG>(); }
ALWAYS_INLINE
uptr MidAppMemEnd(void) { return MappingArchImpl<MAPPING_MID_APP_END>(); }
#endif

ALWAYS_INLINE
uptr HeapMemBeg(void) { return MappingArchImpl<MAPPING_HEAP_BEG>(); }
ALWAYS_INLINE
uptr HeapMemEnd(void) { return MappingArchImpl<MAPPING_HEAP_END>(); }

ALWAYS_INLINE
uptr HiAppMemBeg(void) { return MappingArchImpl<MAPPING_HI_APP_BEG>(); }
ALWAYS_INLINE
uptr HiAppMemEnd(void) { return MappingArchImpl<MAPPING_HI_APP_END>(); }

ALWAYS_INLINE
uptr VdsoBeg(void) { return MappingArchImpl<MAPPING_VDSO_BEG>(); }

#else

ALWAYS_INLINE
uptr AppMemBeg(void) { return MappingArchImpl<MAPPING_APP_BEG>(); }
ALWAYS_INLINE
uptr AppMemEnd(void) { return MappingArchImpl<MAPPING_APP_END>(); }

#endif

static inline bool GetUserRegion(int i, uptr *start, uptr *end) {
  switch (i) {
    default:
      return false;
#if !SANITIZER_GO
...
ALWAYS_INLINE
uptr ShadowBeg(void) { return MappingArchImpl<MAPPING_SHADOW_BEG>(); }
ALWAYS_INLINE
uptr ShadowEnd(void) { return MappingArchImpl<MAPPING_SHADOW_END>(); }

ALWAYS_INLINE
uptr MetaShadowBeg(void) { return MappingArchImpl<MAPPING_META_SHADOW_BEG>(); }
ALWAYS_INLINE
uptr MetaShadowEnd(void) { return MappingArchImpl<MAPPING_META_SHADOW_END>(); }

ALWAYS_INLINE
uptr TraceMemBeg(void) { return MappingArchImpl<MAPPING_TRACE_BEG>(); }
ALWAYS_INLINE
...
bool IsShadowMem(uptr mem) {
  ...
  switch (vmaSize) {
    ...
    case 48:
      return IsShadowMemImpl<Mapping48>(mem);
  }
  DCHECK(0);
  return false;
#elif defined(__powerpc64__)
  switch (vmaSize) {
    ...
    case 47:
      return IsShadowMemImpl<Mapping47>(mem);
  }
  DCHECK(0);
  return false;
#else
...
bool IsMetaMem(uptr mem) {
  ...
  switch (vmaSize) {
    ...
    case 48:
      return IsMetaMemImpl<Mapping48>(mem);
  }
  DCHECK(0);
  return false;
#elif defined(__powerpc64__)
  switch (vmaSize) {
    ...
    case 47:
      return IsMetaMemImpl<Mapping47>(mem);
  }
  DCHECK(0);
  return false;
#else
...
uptr MemToShadow(uptr x) {
  ...
  switch (vmaSize) {
    ...
    case 48:
      return MemToShadowImpl<Mapping48>(x);
  }
  DCHECK(0);
  return 0;
#elif defined(__powerpc64__)
  switch (vmaSize) {
    ...
    case 47:
      return MemToShadowImpl<Mapping47>(x);
  }
  DCHECK(0);
  return 0;
#else
...
#else
#ifndef SANITIZER_WINDOWS
  return (u32 *)(((x & ~(kMetaShadowCell - 1)) / kMetaShadowCell *
                  kMetaShadowSize) |
                 Mapping::kMetaShadowBeg);
#else
  return (u32 *)(((x & ~(kMetaShadowCell - 1)) / kMetaShadowCell *
...
u32 *MemToMeta(uptr x) {
  ...
  switch (vmaSize) {
    ...
    case 48:
      return MemToMetaImpl<Mapping48>(x);
  }
  DCHECK(0);
  return 0;
#elif defined(__powerpc64__)
  switch (vmaSize) {
    ...
    case 47:
      return MemToMetaImpl<Mapping47>(x);
  }
  DCHECK(0);
  return 0;
#else
...
uptr ShadowToMem(uptr s) {
  ...
  switch (vmaSize) {
    ...
    case 48:
      return ShadowToMemImpl<Mapping48>(s);
  }
  DCHECK(0);
  return 0;
#elif defined(__powerpc64__)
  switch (vmaSize) {
    ...
    case 47:
      return ShadowToMemImpl<Mapping47>(s);
  }
  DCHECK(0);
  return 0;
#else
...
const uptr kTotalTraceSize =
    (kTraceSize * sizeof(Event) + sizeof(Trace) + (64 << 10) + (64 << 10) - 1) &
    ~((64 << 10) - 1);
...
uptr GetThreadTrace(int tid) {
  ...
  switch (vmaSize) {
    ...
    case 48:
      return GetThreadTraceImpl<Mapping48>(tid);
  }
  DCHECK(0);
  return 0;
#elif defined(__powerpc64__)
  switch (vmaSize) {
    ...
    case 47:
      return GetThreadTraceImpl<Mapping47>(tid);
  }
  DCHECK(0);
  return 0;
#else
...
uptr GetThreadTraceHeader(int tid) {
  ...
  switch (vmaSize) {
    ...
    case 48:
      return GetThreadTraceHeaderImpl<Mapping48>(tid);
  }
  DCHECK(0);
  return 0;
#elif defined(__powerpc64__)
  switch (vmaSize) {
    ...
    case 47:
      return GetThreadTraceHeaderImpl<Mapping47>(tid);
  }
  DCHECK(0);
  return 0;
#else
