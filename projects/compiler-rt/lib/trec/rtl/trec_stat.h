...
enum StatType {
  ...
  Stat__trec_mutex_create,
  Stat__trec_mutex_destroy,
  Stat__trec_mutex_pre_lock,
  Stat__trec_mutex_post_lock,
  Stat__trec_mutex_pre_unlock,
  Stat__trec_mutex_post_unlock,
  Stat__trec_mutex_pre_signal,
  Stat__trec_mutex_post_signal,
  Stat__trec_mutex_pre_divert,
  Stat__trec_mutex_post_divert,
