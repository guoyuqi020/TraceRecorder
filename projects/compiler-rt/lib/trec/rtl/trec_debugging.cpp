...
//
// TRec debugging API implementation.
//===----------------------------------------------------------------------===//
...
void *__trec_get_current_report() {
  return const_cast<ReportDesc*>(cur_thread()->current_report);
}

SANITIZER_INTERFACE_ATTRIBUTE
int __trec_get_report_data(void *report, const char **description, int *count,
...
SANITIZER_INTERFACE_ATTRIBUTE
int __trec_get_report_tag(void *report, uptr *tag) {
  const ReportDesc *rep = (ReportDesc *)report;
  *tag = rep->tag;
  return 1;
}
...
SANITIZER_INTERFACE_ATTRIBUTE
int __trec_get_report_stack(void *report, uptr idx, void **trace,
                            uptr trace_size) {
  const ReportDesc *rep = (ReportDesc *)report;
...
SANITIZER_INTERFACE_ATTRIBUTE
int __trec_get_report_mop(void *report, uptr idx, int *tid, void **addr,
...
SANITIZER_INTERFACE_ATTRIBUTE
int __trec_get_report_loc(void *report, uptr idx, const char **type,
...
SANITIZER_INTERFACE_ATTRIBUTE
int __trec_get_report_loc_object_type(void *report, uptr idx,
...
SANITIZER_INTERFACE_ATTRIBUTE
int __trec_get_report_mutex(void *report, uptr idx, uptr *mutex_id, void **addr,
...
SANITIZER_INTERFACE_ATTRIBUTE
int __trec_get_report_thread(void *report, uptr idx, int *tid, tid_t *os_id,
...
SANITIZER_INTERFACE_ATTRIBUTE
int __trec_get_report_unique_tid(void *report, uptr idx, int *tid) {
  const ReportDesc *rep = (ReportDesc *)report;
...
SANITIZER_INTERFACE_ATTRIBUTE
const char *__trec_locate_address(uptr addr, char *name, uptr name_size,
...
SANITIZER_INTERFACE_ATTRIBUTE
int __trec_get_alloc_stack(uptr addr, uptr *trace, uptr size, int *thread_id,
                           tid_t *os_id) {
  MBlock *b = 0;
  Allocator *a = allocator();
  if (a->PointerIsMine((void *)addr)) {
